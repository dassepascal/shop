<x-form wire:submit="save">
    ...
    <x-input label="{{ __('Weight in kg') }}" wire:model="weight" required
        placeholder="{{ __('Enter product weight') }}" />

    <x-input label="{{ __('Price') }}" wire:model="price" required placeholder="{{ __('Enter product price') }}" />

    <x-input label="{{ __('Quantity available') }}" wire:model="quantity" type="number" required
        placeholder="{{ __('Enter product quantity') }}" />

    <x-input label="{{ __('Quantity for stock alert') }}" wire:model="quantity_alert" type="number" required
        placeholder="{{ __('Enter product quantity') }}" />
    ...
    @if ($promotion)
        <x-input label="{{ __('Promotion price') }}" wire:model="promotion_price"
            placeholder="{{ __('Enter product promotion price') }}" />

        <x-datetime label="{{ __('Promotion start date') }}" icon="o-calendar" wire:model="promotion_start_date"
            type="date" />

        <x-datetime label="{{ __('Promotion end date') }}" icon="o-calendar" wire:model="promotion_end_date"
            type="date" />
    @endif
